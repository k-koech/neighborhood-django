...
class ProjectsTestClass(TestCase):
    def setUp(self):
        ...
        self.user=Users(name="kelvin kip",profile_photo = 'xyz.png', email="triplek@gmail.com", phone_number ='+254725801772',date_joined="2021-09-05 22:16:35.61389+03",neighborhood=self.neighborhood)
        self.user.save()
    ...
    def tearDown(self):
        ...
        # ReviewReview.objects.all().delete()
